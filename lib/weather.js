    ...
    return new Promise((resolve, reject) => {
        request({
            ...
            method: 'GET'
                ...
                if (err || !body) {
                    return reject(`Whoops! May be http://www.ncu.edu.tw is dead, error message:\n\n${err}\n`)
                }
                ...
                if (!weatherHtml) {
                    return reject('Whoops! The program is outdate, cann\'t get things from http://www.ncu.edu.tw')
                }
...
const resolve = ({ temperature, precip }) => {
    let result = ''
